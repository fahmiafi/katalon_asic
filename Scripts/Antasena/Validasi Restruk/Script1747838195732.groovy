...
Sheet sheetSkenario = workbook.getSheet("Skenario Restruk")
...
//		WebUI.delay(7)
		...
		int NumberAct = 1
		if (UseCase == 'Restrukturisasi Rekening') {
...
//			WebUI.delay(20)
			...
			WebUI.delay(3)
			WebUI.takeScreenshot(newDirectoryPath + '/'+ numberCapture++ +'. Muncul popup message.png')
			if (Title == 'Success') {

...
Sheet sheet3 = workbook.getSheet("Detail Pemindahbukuan")
...
if (row != null) {
	RekDebit = String.valueOf((long) row.getCell(0).getNumericCellValue())
...
WebUI.setText(findTestObject('Object Repository/Activity/ActivtyPemindahbukuan/textarea_DetailPemindahan.Narasi'),  Pencairan+" "+Skenario)

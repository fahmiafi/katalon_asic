...
//			TestObject dropdownApproveOrReject = findTestObject('Object Repository/COP/Approval_Object/select_Approve_or_Reject')
//			WebElement selectElement = driver.findElement(By.xpath("//select[@id='Action']"))
...
//						WebUI.delay(3)
						...
						WebUI.delay(1)
//						List<WebElement> approverOptions = driver.findElements(By.xpath("//li[contains(@class,'select2-results__option') and contains(text(),'" + NextApprover + "')]"))
//						approverOptions[0].click()
			...
			if (RejectBatch == true) {
		//		jsExecutor.executeScript("window.scrollTo(0, document.body.scrollHeight);")
		//		WebUI.takeScreenshot(newDirectoryPath + '/ERROR '+ tc +' List Approval tidak ada '+ApproverCount+'.png')
		//		WebUI.scrollToElement(findTestObject('Object Repository/COP/Approval_Object/label_Appoval_List Aktivitas'), 30)
		//		WebUI.delay(3)
		//		WebUI.click(findTestObject('Object Repository/COP/Approval_Object/button_Approval_View'))
		//		WebUI.delay(3)
		//		WebUI.selectOptionByValue(findTestObject('Object Repository/COP/Approval_Object/select_Approve_or_Reject'), 'Reject', true)
		//		WebUI.click(findTestObject('Object Repository/COP/Approval_Object/button_Approval_Confirm'))
		//		WebUI.delay(5)
		//		WebUI.click(findTestObject('Object Repository/COP/UpdateAfterInquiry_Object/button_OK_sukses_submit'))
		...
		WebUI.scrollToElement(findTestObject('Object Repository/COP/UpdateAfterInquiry_Object/button_View Summary'), 30)
